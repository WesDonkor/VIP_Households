...
lyr_EnumPinnedGPS_020425_4.set('fieldLabels', {'community': 'inline label - always visible', 'e_gpslatitude': 'no label', 'e_gpslongitude': 'no label', 'e_gpsaltitude': 'no label', 'e_gpsaccuracy': 'no label', 'outcome': 'inline label - always visible', 'starttime': 'no label', 'endtime': 'no label', 'Start Time Rank': 'inline label - always visible', 'End Time Rank': 'inline label - always visible', 'compid': 'inline label - always visible', });
lyr_SystempinnedGPS_020425_5.set('fieldLabels', {'community': 'inline label - always visible', 's_gpsblatitude': 'no label', 's_gpsblongitude': 'no label', 's_gpsbaltitude': 'no label', 's_gpsbaccuracy': 'no label', 'outcome': 'inline label - always visible', 'starttime': 'no label', 'endtime': 'no label', 'Start Time Rank': 'inline label - always visible', 'End Time Rank': 'inline label - always visible', 'compid': 'inline label - always visible', });
